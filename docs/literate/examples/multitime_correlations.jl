...
# ```
#
# for a system spin coupled to one bath spin. The complete three-correlator
# plotting workflow lives in `scripts/pt_multitime_correlations.jl`.
...
#     - Run `scripts/pt_multitime_correlations.jl` for the larger grid,
#       additional operator pairs, live progress, and plotting.
