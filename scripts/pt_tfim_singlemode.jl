...
#
# File: scripts/pt_tfim_singlemode.jl
...
const joint_ed_frob_tol = 0.08  # matches test/process_tensor/test_ed_tfi_vs_dense.jl
...
fig_path = joinpath(output_dir, "pt_tfim_singlemode.png")
save(fig_path, fig)
...
println("Completed single-mode process-tensor benchmark.")
println()
