...
#
# File: test/mps/test_observables.jl
# Contributor: Gauthameshwar S.
#
# Tests that compact MPS observable helpers forward correctly on wrapped
...
@testset "API surface: MPS observable exports" begin
    for name in (:inner, :dot, :norm, :expect, :correlation_matrix, :entropy)
